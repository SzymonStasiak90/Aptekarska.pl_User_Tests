...
WebUI.click(findTestObject('Button/span_Panel boczny_icon-bar/div_Panel boczny'))

WebUI.click(findTestObject('Object Repository/Page_Aptekarska Szkoa Zarzdzania Wszystkie kursy/span_Strona gwna'))
