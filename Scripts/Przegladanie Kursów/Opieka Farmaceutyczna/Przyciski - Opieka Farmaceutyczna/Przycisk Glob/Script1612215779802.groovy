...
WebUI.click(findTestObject('Object Repository/Page_Aptekarska Szkoa Zarzdzania/i_Panel boczny_fa fa-globe'))

// copy

WebUI.switchToWindowUrl('https://www.aptekarska.pl/')

WebUI.verifyEqual(WebUI.getUrl(), 'https://www.aptekarska.pl/')

WebUI.closeWindowUrl('https://www.aptekarska.pl/')
