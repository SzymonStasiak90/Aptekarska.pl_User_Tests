...
WebUI.click(findTestObject('Object Repository/Page_Aptekarska Szkoa Zarzdzania/button_Akceptuj wszystko'))

WebUI.click(findTestObject('Object Repository/Page_Aptekarska Szkoa Zarzdzania/a_Zaloguj si'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('FORMULARZ LOGOWANIA/Page_Aptekarska Szkoa Zarzdzania Zaloguj si do serwisu/input_Nazwa uytkownika'))
...
WebUI.setText(findTestObject('FORMULARZ LOGOWANIA/Page_Aptekarska Szkoa Zarzdzania Zaloguj si do serwisu/input_Nazwa uytkownika'), 
    'szymon.stasiak.intersiec@gmail.com', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Page_Aptekarska Szkoa Zarzdzania/span_Profil'))
